...
<p align="center">
  ...
  <a href="../../actions/workflows/AirysDark-AI_build.yml">
    <img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/AirysDark-AI_builder/AirysDark-AI_build.yml?label=Build">
  </a>
  <a href="../../actions/workflows/AirysDark-AI_android.yml">
    <img alt="Android status" src="https://img.shields.io/github/actions/workflow/status/AirysDark-AI_builder/AirysDark-AI_android.yml?label=Android">
  </a>
</p>
